...
export type LogCategory = 'command_execution' | 'command_failure' | 'permission_denial' | 'config_change' | 'startup' | 'shutdown' | 'database_error' | 'api_error' | 'unhandled_exception';
