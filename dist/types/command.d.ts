import type { Message, PermissionResolvable, Guild, GuildMember, GuildTextBasedChannel } from 'discord.js';
...
export type ArgumentTokenType = 'text' | 'mention_user' | 'mention_role' | 'mention_channel' | 'snowflake' | 'url' | 'quoted';
...
export declare function defineCommand(options: CommandOptions): CommandDefinition;
