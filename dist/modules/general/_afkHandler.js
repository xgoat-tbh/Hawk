...
import { buildAfkNoticePayload, buildAfkWelcomeBackPayload, buildAfkPastTensePayload, AFK_ALLOWED_MENTIONS, } from './afkUI.js';
                        ...
                        if (removed.channelId && removed.messageId) {
                            try {
                                const targetChannel = (message.guild?.channels.cache.get(removed.channelId) ??
                                    await message.guild?.channels.fetch(removed.channelId).catch(() => null));
...
//# sourceMappingURL=_afkHandler.js.map