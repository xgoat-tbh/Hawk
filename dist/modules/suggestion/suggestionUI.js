...
export function buildSuggestionPayload(suggestion, authorTag, reason) {
...
export function buildSuggestionPanelPayload() {
...
export async function resolveSuggestionTarget(input, guildId, message) {
...
//# sourceMappingURL=suggestionUI.js.map