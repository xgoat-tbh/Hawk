...
import { getMaintenanceState, setMaintenanceState, } from '../../core/database/repositories/systemRepo.js';
import { ui } from '../../core/ui/index.js';
import { logAuditAction } from '../../core/logging/AuditLogger.js';
import { logEvent } from '../../core/logging/WebhookLogger.js';
function buildMaintenanceCard(state, userIsOwner) {
    ...
    if (userIsOwner) {
        ...
        row = new ActionRowBuilder().addComponents(toggleBtn);
    }
