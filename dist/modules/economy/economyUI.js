...
export function buildBalancePayload(member, balance, currencySymbol) {
    ...
    const content = `• **Wallet / Cash:** \`${currencySymbol}${balance.cash.toLocaleString()}\`\n` +
...
export function buildLeaderboardPayload(entries, page, totalPages, sortBy, currencySymbol, guildName, invokerId) {
    ...
    const actionRow = new ActionRowBuilder().addComponents(prevBtn, pageIndicator, nextBtn);
    return ui.standard({
...
//# sourceMappingURL=economyUI.js.map