...
export default defineCommand({
    ...
    async execute(ctx) {
        ...
        const isTestChannel = Boolean((testChannelId && channel.id === testChannelId) ||
        ...
        if (isTestChannel) {
            ...
            if (remainingCooldown > 0) {
                await respond.warning(`The ping destination \`${pingConfig.identifier}\` (${pingConfig.gameName}) is on cooldown for **${remainingCooldown}s**.`);
                return;
            }
        }
