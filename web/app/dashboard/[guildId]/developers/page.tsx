      ...
      {activeTab === 'hierarchy' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Tier 0: Bot Owner */}
            <div className="bg-[#0c0d10] border border-indigo-500/30 rounded-xl p-5 relative overflow-hidden space-y-4">
              ...
              <div className="pt-3 border-t border-[#1a1d24] text-xs text-[#c1c7cd] space-y-2">
            ...
            {/* Tier 1: Server Owner */}
            <div className="bg-[#0c0d10] border border-amber-500/30 rounded-xl p-5 relative overflow-hidden space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
        ...
        <div className="bg-[#0c0d10] border border-[#1a1d24] rounded-xl p-5 space-y-5">
          ...
          {permits.length === 0 ? (
            <div className="py-12 text-center text-xs text-[#717882]">
              ...
              <p className="text-sm font-semibold text-white">No explicit custom permits</p>
              <p className="mt-1">Only Bot Owner (Tier 0) and Server Owner (Tier 1) have master authority.</p>
            </div>
          ) : (
            <div className="overflow-x-auto border border-[#1a1d24] rounded-lg">
              <table className="w-full text-left text-xs text-[#c1c7cd]">
                ...
                <tbody className="divide-y divide-[#16181e] bg-[#121418]">
                  {permits.map((p: any, idx: number) => (
                    <tr key={idx} className="hover:bg-[#16181d]/60">
      ...
      {activeTab === 'protocols' && (
        <div className="bg-[#0c0d10] border border-[#1a1d24] rounded-xl p-5 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg bg-[#14161b] border border-[#20242c] space-y-2">
              <div className="flex items-center gap-2 text-indigo-400 font-semibold text-xs">
                <ShieldCheck className="w-4 h-4" />
                <span>Overlord Bypass Invariant</span>
              </div>
              <p className="text-xs text-[#8c949e] leading-relaxed">
