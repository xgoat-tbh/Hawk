        ...
        <div className="bg-[#0c0d10] border border-[#1a1d24] rounded-xl p-5 space-y-5">
          ...
          {stickyMessages.length === 0 ? (
            <div className="py-12 text-center text-xs text-[#717882]">
              ...
              <p className="text-sm font-semibold text-white">No sticky notices configured</p>
            ...
            <div className="divide-y divide-[#1a1d24] border border-[#1a1d24] rounded-lg overflow-hidden bg-[#121418]">
              {stickyMessages.map((item: any) => {
                ...
                return (
                  <div key={item.channel_id} className="p-4 hover:bg-[#16181d]/50 transition-colors space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-mono text-[#717882]">{item.channel_id}</span>
                      </div>
                        ...
                        {isEditing ? (
                          <>
                            <button
                              ...
                              className="px-2.5 py-1 text-xs font-medium rounded-md bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/20 flex items-center gap-1 transition-colors"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-md bg-[#16181d] text-[#717882] hover:text-white border border-[#262a33] transition-colors"
                            >
                          ...
                          <>
                            <button
                              ...
                              className="p-1.5 rounded-md bg-[#16181d] hover:bg-[#20232b] text-[#c1c7cd] hover:text-white border border-[#262a33] transition-colors"
                              title="Edit notice"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-md bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/20 transition-colors"
                              title="Delete notice"
                            >
                    ...
                    {isEditing ? (
                      <div className="space-y-2">
                        <textarea
                          ...
                          rows={3}
                          className="w-full bg-[#14161b] border border-[#20242c] rounded-lg p-3 text-xs text-white focus:outline-none focus:border-indigo-500 font-sans"
                        />
                        <div className="flex items-center gap-1.5">
                          {variables.map((v) => (
                            <button
                              ...
                              className="px-2 py-0.5 rounded bg-[#16181d] hover:bg-[#20232b] border border-[#262a33] text-[10px] font-mono text-[#8c949e] hover:text-white transition-colors"
                            >
                              {v}
                            </button>
                          ))}
                      ...
                      <div className="p-3 rounded-lg bg-[#14161b] border border-[#1e222a] text-xs text-[#c1c7cd] leading-relaxed whitespace-pre-wrap font-sans">
                        {noticeText}
                      </div>
                    )}
                  </div>
      ...
      {activeTab === 'create' && (
        <div className="bg-[#0c0d10] border border-[#1a1d24] rounded-xl p-5 space-y-5">
          ...
          <form onSubmit={handleAddSticky} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <label className="text-xs font-medium text-white">Notice Content</label>
                <div className="flex items-center gap-1.5">
                  {variables.map((v) => (
                    <button
                      key={v}
              ...
              <textarea
                ...
                className="w-full bg-[#14161b] border border-[#20242c] rounded-lg p-3 text-xs text-white focus:outline-none focus:border-indigo-500 font-sans"
              />
              <div className="text-right text-[10px] font-mono text-[#717882]">
      ...
      {activeTab === 'variables' && (
        <div className="bg-[#0c0d10] border border-[#1a1d24] rounded-xl p-5 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg bg-[#14161b] border border-[#20242c] space-y-1">
              <span className="px-1.5 py-0.5 rounded text-[10px] font-mono bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                &#123;user&#125;
              </span>
              <p className="text-xs text-white font-medium mt-1">Author / Last Speaker</p>
              <p className="text-xs text-[#8c949e]">Mentions the member who triggered the sticky resurface.</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-[#14161b] border border-[#20242c] space-y-1">
              ...
              <p className="text-xs text-white font-medium mt-1">Guild Display Name</p>
              <p className="text-xs text-[#8c949e]">Replaced with the server name automatically.</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-[#14161b] border border-[#20242c] space-y-1">
              ...
              <p className="text-xs text-white font-medium mt-1">Rules Channel Link</p>
              <p className="text-xs text-[#8c949e]">Resolves to the primary rules channel mention if detected.</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-[#14161b] border border-[#20242c] space-y-1">
              ...
              <p className="text-xs text-white font-medium mt-1">Discord Styling</p>
              <p className="text-xs text-[#8c949e]">Supports bold (**text**), italics (*text*), spoilers, and links.</p>
            </div>
          </div>
        </div>
      )}
